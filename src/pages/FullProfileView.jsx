...
const FullProfileView = () => {
 ...
 bg-gradient-to-r h-[750px] from-red-100 to-sky-50 mt-8 mb-8 max-w-sm mx-auto bg-white rounded-2xl  overflow-hidden transform transition-all duration-300"
            ...
            <div className="flex justify-center mt-10"><p  style={{ backgroundColor: profile.color }} className="text-center text-fuchsia-100 py-2 px-4 bg-orange-400 rounded-t-lg w-[380px] place-items-center">Developed by <a href="#" rel="noopener noreferrer" target="_blank" class="text-gray-800">May Khine</a></p></div>
        </div>
    )
}
